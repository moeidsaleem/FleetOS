...
import { Car, CarTaxiFrontIcon, Magnet, Truck, User2Icon } from "lucide-react";
...
export function FleetOSAnimatedBeams({
  className,
}: {
  className?: string;
}) {
    ...
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div1Ref}>
            <CarTaxiFrontIcon className="text-indigo-600" />
          </Circle>
          <Circle ref={div2Ref}>
          ...
          <Circle ref={div5Ref}>
            <Magnet className="text-purple-600" />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-16 bg-gradient-to-r from-blue-600/5 via-purple-600/5 to-pink-600/5">
            <MagicLogo size={32} className="text-black" />
            {/* <span className="text-black">FleetOS</span> */}
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={div7Ref}>
